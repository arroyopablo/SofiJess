...
public class GenerarPdfProducto extends javax.swing.JFrame {

    public GenerarPdfProducto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GENERAR REPORTE PRODUCTO");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Precio", "Nombre Proveedor", "Todo" }));
    ...
    modelo.DAOProducto produ = new modelo.DAOProducto();
    private void GenerarPdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerarPdfActionPerformed
        ...
        if(jComboBox1.getSelectedItem().toString().equals("Todo")){
               ...
               produ.generarPdf(dato,jComboBox1.getSelectedItem().toString());
        }else if(jtxDato.getText().equals("")){
            JOptionPane.showMessageDialog(null, "DEBE INGRESAR UN DATO");
        }else{
            String dato = jtxDato.getText();
            produ.setPrecioPro(Integer.parseInt(jtxDato.getText()));
            produ.generarPdf(dato,jComboBox1.getSelectedItem().toString());
        }
