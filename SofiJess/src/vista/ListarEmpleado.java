...
public class ListarEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("LISTAR EMPELADO");
        ...
        cboxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Apellido", "Cargo", "Sueldo", "Barrio" }));
        ...
        tblDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE", "APELLIDO", "CEDULA", "TELEFONO", "DIRECCION", "BARRIO", "SUELDO", "CARGO"
            }
        ) {
    ...
    private void botonListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonListarActionPerformed
        ...
        listarEmple.setSueldo(Integer.parseInt(txtValorBusqueda.getText()));
        listarEmple.listarEmpl(txtValorBusqueda.getText(),cboxFiltro.getSelectedItem().toString(),tblDatos);
        limpiarCampos();
        }   
